...
export default function WidgetBudget() {
  return (
    <div className="border-[#EDEDED grid grid-cols-2 gap-4 rounded-xl border bg-white p-6 md:grid-cols-3">
      <div className="flex flex-col items-center space-y-2 hover:bg-gray-100/60 rounded-lg pb-1">
        <CircularProgress
          color="#2562E8"
          progress={23}
          icon={<Car size={28} />}
